...
class EachCategory extends Component
{
    ...
    return(
                ...
                <a style={{textDecoration:'none'}} onClick={this.plusClicked} data-toggle="collapse" href={c} aria-expanded="false" aria-controls={c}><h5 className="card-header yoyo" style={{ backgroundColor: "#26a69a", color: "white" }}>{this.props.category.toUpperCase()}<span id="collapseButton">{this.state.plus}</span></h5></a>
