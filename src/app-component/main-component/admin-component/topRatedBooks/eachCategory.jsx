...
export const EachCategory=(props)=>
{
    ...
    return(
                ...
                <a data-toggle="collapse" href={c} aria-expanded="false" aria-controls={c}><h5 className="card-header yoyo" style={{ backgroundColor: "#8a0051", color: "white" }}>{props.category.toUpperCase()}</h5></a>
