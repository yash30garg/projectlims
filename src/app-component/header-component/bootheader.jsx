                        ...
                        <div className="row">
                            <div className="col-md-3">
                                ...
                                <div className="list-group">
                                    ...
                                    <a href="#" class="list-group-item  list-group-item-action"> <span class="fa fa-asterisk" aria-hidden="true">
                                    </span>Dot Net<div className='mov' style={{ paddingRight: "195px" }} /><span className="badge badge-pill badge-warning">13</span></a>
                                    <a href="#" class="list-group-item  list-group-item-action"> <span class="fa fa-asterisk" aria-hidden="true">
                                    </span>Angular<div className='mov' style={{ paddingRight: "195px" }} /><span className="badge badge-pill badge-warning">17</span></a>
                                    <a href="#" class="list-group-item  list-group-item-action"> <span class="fa fa-asterisk" aria-hidden="true">
                                    </span>React<div className='mov' style={{ paddingRight: "212px" }} /><span className="badge badge-pill badge-warning">14</span></a>
                                    <a href="#" class="list-group-item  list-group-item-action"> <span class="fa fa-asterisk" aria-hidden="true">
                                    </span>Mongo<div className='mov' style={{ paddingRight: "204px" }} /><span className="badge badge-pill badge-warning">6</span></a>
                                    <a href="#" class="list-group-item  list-group-item-action"> <span class="fa fa-asterisk" aria-hidden="true">
                                    </span>PHP<div className='mov' style={{ paddingRight: "220px" }} /><span className="badge badge-pill badge-warning">16</span></a>
                                    <a href="#" class="list-group-item  list-group-item-action"> <span class="fa fa-asterisk" aria-hidden="true">
                                    </span>Python<div className='mov' style={{ paddingRight: "200px" }} /><span className="badge badge-pill badge-warning">14</span></a>
